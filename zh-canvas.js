...
var cnItems = {
    ...
    'Letter': '字母',
    'Monsters dropped': '怪物掉落',
    'Stun slowdown': '晕眩减速',
    'Stun duration': '晕眩持续时间',
    'Stun chance': '晕眩几率',
    'Health damage': '生命值伤害',
    'HP based damage': '基于生命值的伤害',
    'Rockster rebirth upgrades': '骷颅怪重生升级',
    'Spikes rebirth upgrades': '尖刺重生升级',
    'Shield damage': '护盾伤害',
    '': '',
    '': '',
    '': '',
...
var cnPrefix = {
    ...
    "Earn at least": "赚取至少",
    ". Earn at least ": ". 赚取至少 ",
    "Game was in background for": "游戏在后台运行了",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Game was in background for (\d+)m (\d+)s$/, '游戏在后台运行了 $1 分 $2 秒'],
    [/^Game was in background for (\d+)h (\d+)m (\d+)s$/, '游戏在后台运行了 $1 小时 $2 分 $3 秒'],
    [/^Game was in background for (\d+)d (\d+)h (\d+)m (\d+)s$/, '游戏在后台运行了 $1 天 $2 小时 $3 分 $4 秒'],
    [/^([\d\.]+) Coins$/, '$1 硬币'],
